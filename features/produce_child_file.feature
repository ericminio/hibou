Feature: Produce a single child file
  ...
  Background:
    ...
    |first name|last name|birth year|birth month|birth day|allergies|notes|
    |George|Orwell|2007|March|23|peanuts|Frequently puts forks in electric plugs|
  ...
  Scenario: Produce a basic child file
    ...
    And I see that his allergies are "peanuts"
